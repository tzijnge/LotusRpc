...
TEST_F(TestServer2_s1, decodeF0)
{
    ...
    EXPECT_RESPONSE("030100", response);
}
...
TEST_F(TestServer2_s1, decodeF1)
{
    ...
    EXPECT_RESPONSE("090101543100543200", response);
}
...
TEST_F(TestServer2_s1, decodeF2)
{
    ...
    EXPECT_RESPONSE("030102", response);
}
...
TEST_F(TestServer2_s1, decodeF3)
{
    ...
    EXPECT_RESPONSE("030103", response);
}
...
TEST_F(TestServer2_s1, decodeF4)
{
    ...
    EXPECT_RESPONSE("07010401543100", response);
}
...
TEST_F(TestServer2_s1, decodeF5)
{
    ...
    EXPECT_RESPONSE("030105", response);
}
...
TEST_F(TestServer2_s1, decodeF6)
{
    ...
    EXPECT_RESPONSE("10010654310054320054330001543400", response);
}
...
TEST_F(TestServer2_s1, decodeF7)
{
    ...
    EXPECT_RESPONSE("090107543132333400", response);
}
...
TEST_F(TestServer2_s1, decodeF8)
{
    ...
    EXPECT_RESPONSE("030108", response);
}
...
TEST_F(TestServer2_s1, decodeF9)
{
    ...
    EXPECT_RESPONSE("030109", response);
}
...
TEST_F(TestServer2_s1, decodeF10)
{
    ...
    EXPECT_RESPONSE("10010A54310054320054330001543400", response);
}