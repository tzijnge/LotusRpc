...
* `definition`. Type: string. This is the version as defined by the user in the [definition file](reference_settings#version). If no version is defined, an empty string is returned.
* `definition_hash`. Type: string. This is the sha3-256 hash of the definition file as generated by `lrpcg` during code generation. The hash has a full length of 64 characters, but is optionally truncated to the length specified in the [definition file](reference_settings#definition_hash_length).
