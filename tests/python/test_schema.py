...
"""
    ...
    assert_log_entries(
        ["Duplicate function name in service s0: f0", "Duplicate function name in service s1: f1"],
        caplog.text,
    )
...
"""
    ...
    load_lrpc_def(rpc_def, warnings_as_errors=False)
...
"""
    ...
    with pytest.raises(
        ...
        load_lrpc_def(rpc_def, warnings_as_errors=True)
