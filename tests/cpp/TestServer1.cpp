...
TEST_F(TestServer1, decodeF2)
{
    ...
    auto response = receive("0400027B");
...
TEST_F(TestServer1, decodeF3)
{
    ...
    auto response = receive("050003ABCD");
...
TEST_F(TestServer1, decodeF4)
{
    ...
    auto response = receive("07000479E9F642");
...
TEST_F(TestServer1, decodeF5)
{
    ...
    auto response = receive("070005AABBCCDD");
...
TEST_F(TestServer1, decodeF6)
{
    ...
    auto response = receive("0800065465737400");
...
{
    EXPECT_CALL(service, f6(etl::string_view("Test")));
    auto response = receive("07000654657374");
    EXPECT_EQ("030006", response);
}
...
TEST_F(TestServer1, decodeF7)
{
    ...
    auto response = receive("090007AABBCCDD7B01");
...
TEST_F(TestServer1, decodeF8)
{
    ...
    auto response = receive("04000803");
...
TEST_F(TestServer1, decodeF9)
{
    ...
    auto response = receive("070009AABBCCDD");
...
TEST_F(TestServer1, decodeF10)
{
    ...
    auto response = receive("06000AAABB01");
...
TEST_F(TestServer1, decodef11)
{
    ...
    auto response = receive("05000B7B6F");
...
TEST_F(TestServer1, decodef22)
{
    ...
    auto response = receive("0D001661726731006172673200");
