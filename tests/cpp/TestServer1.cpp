...
TEST_F(TestServer1, decodeF0)
{
    ...
    EXPECT_RESPONSE("030000", response);
}
...
TEST_F(TestServer1, decodeF1)
{
    ...
    EXPECT_RESPONSE("030001", response);
}
...
TEST_F(TestServer1, decodeF2)
{
    ...
    EXPECT_RESPONSE("030002", response);
}
...
TEST_F(TestServer1, decodeF3)
{
    ...
    EXPECT_RESPONSE("030003", response);
}
...
TEST_F(TestServer1, decodeF4)
{
    ...
    EXPECT_RESPONSE("030004", response);
}
...
TEST_F(TestServer1, decodeF5)
{
    ...
    EXPECT_RESPONSE("030005", response);
}
...
TEST_F(TestServer1, decodeF6)
{
    ...
    EXPECT_RESPONSE("030006", response);
}
...
TEST_F(TestServer1, decodeF7)
{
    ...
    EXPECT_RESPONSE("030007", response);
}
...
TEST_F(TestServer1, decodeF8)
{
    ...
    EXPECT_RESPONSE("030008", response);
}
...
TEST_F(TestServer1, decodeF9)
{
    ...
    EXPECT_RESPONSE("030009", response);
}
...
TEST_F(TestServer1, decodeF10)
{
    ...
    EXPECT_RESPONSE("03000A", response);
}
...
TEST_F(TestServer1, decodef11)
{
    ...
    EXPECT_RESPONSE("03000B", response);
}
...
TEST_F(TestServer1, decodef12)
{
    ...
    EXPECT_RESPONSE("04000CAB", response);
}
...
TEST_F(TestServer1, decodef13)
{
    ...
    EXPECT_RESPONSE("05000DCDAB", response);
}
...
TEST_F(TestServer1, decodeF14)
{
    ...
    EXPECT_RESPONSE("07000E79E9F642", response);
}
...
TEST_F(TestServer1, decodeF15)
{
    ...
    EXPECT_RESPONSE("07000FAABBCCDD", response);
}
...
TEST_F(TestServer1, decodeF16)
{
    ...
    EXPECT_RESPONSE("0C0010546573740000000000", response);
}
...
TEST_F(TestServer1, decodeF17)
{
    ...
    EXPECT_RESPONSE("090011AABBCCDD7B01", response);
}
...
TEST_F(TestServer1, decodeF18)
{
    ...
    EXPECT_RESPONSE("04001203", response);
}
...
TEST_F(TestServer1, decodeF19)
{
    ...
    EXPECT_RESPONSE("070013AABBCCDD", response);
}
...
TEST_F(TestServer1, decodeF20)
{
    ...
    EXPECT_RESPONSE("060014AABB02", response);
}
...
TEST_F(TestServer1, decodef21)
{
    ...
    EXPECT_RESPONSE("0500157B6F", response);
}
...
TEST_F(TestServer1, decodef22)
{
    ...
    EXPECT_RESPONSE("0D001672657431007265743200", response);
}
...
TEST_F(TestServer1, decodef23)
{
    ...
    EXPECT_RESPONSE("0800175465737400", response);
}
...
TEST_F(TestServer1, decodef24)
{
    ...
    EXPECT_RESPONSE("090018543100543200", response);
}
...
TEST_F(TestServer1, decodef25)
{
    ...
    EXPECT_RESPONSE("07001901543100", response);

    EXPECT_CALL(service, f25()).WillOnce(Return(etl::optional<etl::string_view>{}));
    response = receive("19");
    EXPECT_RESPONSE("04001900", response);
}
...
TEST_F(TestServer1, decodef26)
{
    ...
    EXPECT_RESPONSE("0F001A546573743100543200543300", response);
}
